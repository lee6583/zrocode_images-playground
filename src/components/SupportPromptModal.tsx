      ...
      >
        ...
        <div className="flex items-center justify-center">
          <button
            type="button"
            onClick={dismissSupportPrompt}
            className="rounded-2xl bg-[#946ce6] px-8 py-3.5 text-[15px] font-semibold text-white transition-all hover:bg-[#8358dc] active:scale-[0.98] dark:bg-[#946ce6] dark:hover:bg-[#a885ee]"
          >
            继续使用
          </button>
        </div>
